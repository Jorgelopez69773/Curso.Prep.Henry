...
else (color !== "blue" && color !== "red" && color !== "green" && color !== "orange") 
{
...
function esEntero(numero) {
  ...
  else (numero - Math.floor(numero) !== 0 ) 
  {
    return false;
  }
}
...
function operadoresLogicos(num1, num2, num3) {
  ...
  else (!(num1 > num2 && num1 > num3 && num1 > 0) && !(num1 <0 || num2 < 0 || num3 < 0) && !(num3 > num1 && num3 > num2) && !(num1 === 0 || num2 === 0 || num3 === 0)) 
  {
    return false;
  }
}
